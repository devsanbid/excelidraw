...
export const setCursorForShape = (
  ...
  if (appState.activeTool.type === "selection") {
    ...
    if (appState.activeTool.type === "freedraw") {
      const strokeColor = appState.theme === THEME.DARK ? "white" : "black";
      interactiveCanvas.style.cursor = `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="${strokeColor}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>') 0 24, crosshair`;
    } else {
